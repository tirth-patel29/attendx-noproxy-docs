...
import { Database, Key, TableProperties, ArrowRight, Network } from 'lucide-react';
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="flex bg-muted p-1 rounded-lg border border-border">
          <button
            ...
            className={`px-4 py-1.5 rounded-md text-sm font-medium flex items-center gap-2 transition-colors ${viewMode === 'table' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
          >
            <TableProperties size={16} /> Data Dictionary
          </button>
          <button
            onClick={() => setViewMode('graph')}
            className={`px-4 py-1.5 rounded-md text-sm font-medium flex items-center gap-2 transition-colors ${viewMode === 'graph' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
          >
